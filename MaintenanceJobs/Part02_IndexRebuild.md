# DDL: Tabela QueueDatabase

Este script SQL cria a tabela `QueueDatabase` no esquema `dbo` se ela não existir, e também adiciona uma chave estrangeira referenciando a tabela `Queue`.
